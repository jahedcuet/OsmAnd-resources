...
language('bn').
fest_language('cmu_bn_awb_arctic_clunits').
...
% ROUTE CALCULATED
string('route_is.ogg', 'এই ভ্রমণটি ').
string('route_calculate.ogg', 'রুট পূণরায় হিসাব করা হল').
string('distance.ogg', 'দূরত্ব ').

% LEFT/RIGHT
%string('prepare.ogg', 'প্রস্তুতি নিন ').
string('after.ogg', 'পরে ').
string('in.ogg', 'এর মধ্যে ').

string('left.ogg', 'বামদিকে যান ').
string('left_sh.ogg', 'তীক্নভাবে বামদিকে যান ').
string('left_sl.ogg', 'হালকা বামে যান    ').
string('right.ogg', 'ডানদিকে যান ').
string('right_sh.ogg', 'turn sharply right ').
string('right_sl.ogg', 'turn slightly right ').
string('left_keep.ogg', 'বামে থাকুন ').
string('right_keep.ogg', 'ডানে থাকুন ').
...
string('then.ogg', ', তারপর ').
string('and.ogg', 'এবং ').
string('take.ogg', 'take the ').
string('exit.ogg', 'exit ').

string('1st.ogg', 'প্রথম ').
string('2nd.ogg', 'দ্বিতীয় ').
string('3rd.ogg', 'তৃতীয় ').
string('4th.ogg', 'চতুর্থ ').
...
string('follow.ogg', 'চলতে থাকুন ').

% ARRIVE
string('and_arrive_destination.ogg', 'and arrive at your destination ').
string('reached_destination.ogg','আপনি আপনার গন্তব্যে পৌঁছে গেছেন ').
...
string('location_lost.ogg', 'জিপিএস সংকেত হারিয়েছে  ').
string('location_recovered.ogg', ' জিপিএস সংকেত আবার পাওয়া গেছে ').
...
string('meters.ogg', 'মিটার ').
string('around_1_kilometer.ogg', 'প্রায় ১ কিলোমিটার ').
string('around.ogg', 'প্রায় ').
string('kilometers.ogg', 'কিলোমিটার ').
...
% TIME SUPPORT
string('time.ogg', 'সময় লাগবে ').
string('1_hour.ogg', 'এক ঘন্টা ').
string('hours.ogg', 'ঘন্টা ').
string('less_a_minute.ogg', 'এক মিনিটের কম ').
string('1_minute.ogg', 'এক মিনিট ').
string('minutes.ogg', 'মিনিট ').
